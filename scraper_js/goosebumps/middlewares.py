...
class OffsiteSpiderMiddleware(OffsiteMiddleware):
    """
    OffsiteDownloaderMiddleware

    ref: https://github.com/scrapy/scrapy/issues/1042#issuecomment-879964440
    """

    def process_request(self, request: Request, spider: Spider) -> None:
        """Quick-and-dirty downloader middleware to workaround"""
        if not list(self.process_spider_output(None, [request], spider)):
            raise IgnoreRequest
